#potentially add a function that help calculate the repair costs based on the types of repairs needed
#potentially add a function that provides an selling price based on the users inputs
